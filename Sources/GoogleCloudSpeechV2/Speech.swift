...
public class SpeechClient: Clients.SpeechProtocol {
  ...
  public func createRecognizer(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try Recognizer(fromAny: anyValueUnwrapped)
  ...
  public func listRecognizers(
    ...
    let listRpc = { (token: String) async throws -> GoogleCloudSpeechV2.ListRecognizersResponse in
      var request = byItem
  ...
  public func batchRecognize(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try BatchRecognizeResponse(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
  ...
  public func createCustomClass(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try CustomClass(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
  ...
  public func listCustomClasses(
    ...
    let listRpc = { (token: String) async throws -> GoogleCloudSpeechV2.ListCustomClassesResponse in
      var request = byItem
      request.pageToken = token
  ...
  public func createPhraseSet(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try PhraseSet(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
  ...
  public func listPhraseSets(
    ...
    let listRpc = { (token: String) async throws -> GoogleCloudSpeechV2.ListPhraseSetsResponse in
      var request = byItem
      request.pageToken = token
